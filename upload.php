...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_FILES['product_img']['name'])) {
        ...
        // rename the image
        $product_img = "$category" . rand(0, 9999) . '.' . $fileExtension;
    ...
    // store radio value of featured
    if (isset($_POST['featured'])) {
        $featured = $_POST['featured'];
    }

    //save to database
    $query = "INSERT INTO `upload` (`product_name`, `product_img`, `product_price`, `product_info`, `featured`, `category`) 
    VALUES ('$product_name', '$product_img', '$product_price', '$product_info', '$featured', '$category')";
    mysqli_query($con, $query);

    $_SESSION['umsg'] = 'Item Added Sucessfully.';
                        ...
                        <div class="signup">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="box">
                                            ...
                                            <select id="category" name="category">
                                                ...
                                                <option value="coats">Coats and Blazers</option>
                                                <option value="shirts">Shirts</option>
                                                <option value="ties">Ties & Bow Ties</option>
                                            </select>
                                        </div>
                                        <div class="box">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="box">
                                            ...
                                              <input type="radio" id="yes" value="yes" name="featured">
                                              <label for="yes">Yes</label>
                                              <input type="radio" id="no" value="no" name="featured" checked>
                                ...
                                <div>
                                    ...
                                    <textarea class="textinput p-2" name="product_info" id="product_info" placeholder="Description"></textarea>
                                </div>
                                <button>Add</button>
                            </form>
                        </div>
